...
// New creates a new Config with default configuration.
func New() *Config {
...
func (config *Config) GetFlakeIdGeneratorConfig(name string) *FlakeIdGeneratorConfig {
	...
	flakeIdConfig := NewFlakeIdGeneratorConfig(name)
	config.flakeIdGeneratorConfigMap[name] = flakeIdConfig
	return flakeIdConfig

}

// AddFlakeIdGeneratorConfig adds the given config to the configurations map.
func (config *Config) AddFlakeIdGeneratorConfig(flakeIdConfig *FlakeIdGeneratorConfig) *Config {
	config.flakeIdGeneratorConfigMap[flakeIdConfig.Name()] = flakeIdConfig
	return config
}
